...
export interface ApiCategoryGroupCategoryGroup
  ...
  attributes: {
    AlphabetEntries: Schema.Attribute.Relation<
      'oneToMany',
      'api::alphabet-entry.alphabet-entry'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    GroupCategory: Schema.Attribute.String & Schema.Attribute.Required;
    KumpulanKategori: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
